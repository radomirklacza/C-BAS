...
EXPEDIENT_EMAIL = '%s@cbas.noc.onelab.eu' %  (EXPEDIENT_NAME,)
...
if __name__ == "__main__":
    ...
    insert_user(ADMIN_NAME,urn,a_c,a_cred,admin_uuid,'System', 'Administrator','root@cbas.noc.onelab.eu', True)
    ...
    insert_user(EXPEDIENT_NAME,urn,a_c,a_cred,exp_uuid,'Expedient', 'User-agent','expedient@cbas.noc.onelab.eu')
